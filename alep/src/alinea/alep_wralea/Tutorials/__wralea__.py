...
# This file has been generated at Thu May 23 16:09:34 2013
...
__all__ = ['_376008080', '_376008112']



_376008080 = CompositeNodeFactory(name='theoric_tutorial_septoria',
   ...
   24: ('openalea.python method', 'eval'),
   25: ('openalea.flow control', 'iter'),
   26: ('openalea.python method', 'eval'),
   27: ('openalea.flow control', 'iter')},
                             elt_connections={  19061596: (27, 0, 9, 5),
   19061608: (26, 0, 27, 0),
   19061620: (25, 0, 8, 5),
   19061632: (24, 0, 25, 0),
   19061644: (13, 0, 9, 1),
   ...
   19061884: (15, 0, 17, 2)},
         ...
         'caption': 'wheat',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x161D01B0> : "wheat"',
         'hide': True,
         'id': 2,
         'lazy': True,
   ...
   3: {  'block': False,
         'caption': '1',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x164BE070> : "int"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x161D0290> : "distribute_dispersal_units"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x1652C890> : "NoPriorityGrowthControl"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'infect',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x16655D50> : "infect"',
         'hide': True,
         'id': 7,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   8: {  'block': False,
         'caption': 'update',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x16655D70> : "update"',
         'hide': True,
         'id': 8,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': 'disperse',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x16655D90> : "disperse"',
         'hide': True,
         'id': 9,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   10: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 108.69222346007832,
          'posy': 155.85969555629524,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   12: {  'block': False,
          'caption': "'septoria'",
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x165115B0> : "string"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 331.0007456109043,
          'posy': 350.19455876265897,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   13: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x161D0250> : "scene_from_g"',
          'hide': True,
          'id': 13,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          'caption': 'g',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x15F73F10> : "pool setdefault"',
          'hide': True,
          'id': 14,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   15: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x161D0230> : "weather_reader"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   17: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x161D0210> : "microclimate"',
          'hide': True,
          'id': 17,
          'lazy': False,
          'port_hide_changed': set(),
   ...
   20: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x161DAFD0> : "update_meteo_date"',
          'hide': True,
          'id': 20,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 207.78073518420823,
          'posy': 79.77150578248624,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   21: {  'factory': '<openalea.core.node.NodeFactory object at 0x15F73EF0> : "annotation"',
          'id': 21,
          'posx': 7.333437712383869,
   ...
   22: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': -26.66718856191914,
          'posy': -38.0747583367384,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   24: {  'block': False,
          'caption': 'eval',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x16669AD0> : "eval"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 317.9077222718833,
          'posy': 206.8613916652917,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   25: {  'block': False,
          'caption': 'iter',
          'delay': 1,
          'factory': '<openalea.core.node.NodeFactory object at 0x15F73F50> : "iter"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 319.64128839771416,
          'posy': 242.6561529357607,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   26: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 414.5648920534906,
          'posy': 315.93324380416954,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   27: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 416.29845817932147,
          'posy': 349.9544790235999,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   3: [(0, '1')],
   4: [  (  3,
            '<alinea.alep.inoculation.RandomInoculation instance at 0x1EF0DBE8>')],
   5: [(0, '10')],
   6: [],
   7: [(2, 'None'), (3, "'LeafElement'"), (4, 'True')],
   8: [(3, 'None'), (4, "'LeafElement'")],
   9: [(4, "'LeafElement'")],
   10: [(0, '1')],
   12: [(0, "'septoria'")],
   13: [],
   ...
   16: [(0, '\'"weather_file"\'')],
   17: [  (  3,
             '<alinea.echap.microclimate_leaf.MicroclimateLeaf instance at 0x1EF2E710>'),
          (5, "'LeafElement'")],
   18: [],
   19: [(0, '1')],
   ...
   10: {'position': [108.69222346007832, 155.85969555629524], 'userColor': None, 'useUserColor': False},
   11: {  'position': [231.7184738650594, 350.9975022228184],
          'useUserColor': False,
          'userColor': None},
   12: {'position': [331.0007456109043, 350.19455876265897], 'userColor': None, 'useUserColor': False},
   ...
   15: {'position': [114.99101469039701, 79.88838185418388], 'userColor': None, 'useUserColor': False},
   16: {'position': [117.00713632610868, 48.46867828452781], 'userColor': None, 'useUserColor': False},
   17: {'position': [13.283884653755273, 156.11970547432756], 'userColor': None, 'useUserColor': False},
   18: {'position': [32.81513954963852, 79.76781061907114], 'userColor': None, 'useUserColor': False},
   19: {'position': [320.42875222318867, 79.76800923300915], 'userColor': None, 'useUserColor': False},
   20: {'position': [207.78073518420823, 79.77150578248624], 'userColor': None, 'useUserColor': False},
   21: {'visualStyle': 1, 'position': [7.333437712383869, 21.185486724664376], 'color': [216, 255, 199], 'text': u'Simulation loop', 'textColor': None, 'rectP2': (472.58689540505054, 446.1946794846164)},
   22: {'position': [-26.66718856191914, -38.0747583367384], 'userColor': None, 'useUserColor': False},
   24: {'useUserColor': False, 'position': [317.9077222718833, 206.8613916652917], 'userColor': None},
   25: {'useUserColor': False, 'position': [319.64128839771416, 242.6561529357607], 'userColor': None},
   26: {'useUserColor': False, 'position': [414.5648920534906, 315.93324380416954], 'userColor': None},
   27: {'useUserColor': False, 'position': [416.29845817932147, 349.9544790235999], 'userColor': None},
...
_376008112 = CompositeNodeFactory(name='tutorial_powdery_mildew_draft',
