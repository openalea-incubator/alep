...
from septo_decomposed import run_disease, get_weather, reconst_db
...
def plot_infection_risk(years=[1998, 2003, 2004, 2010], nplants = 6, nsect = 5, disc_level = 30):
    ...
    for i, ax in enumerate(axs.flat):
        ...
        plot_septo_infection_risk(weather = weather, adel = adel, start_date = start_date, ax = ax, xlims = [0, 2000])
