...
def simu(nb_plants):
    dir_path = './adel/tremie_2013_'+str(nb_plants)+'pl_7sect'
    g, recorder = run_disease(start_date="2012-10-29 12:00:00", end_date="2013-08-01 00:00:00",
                                variety = 'Tremie13', nplants=nb_plants, nsect=7,
    ...
    stored_rec = './tremie/recorder_stabtest_tremie13_'+str(nb_plants)+'pl.pckl'
