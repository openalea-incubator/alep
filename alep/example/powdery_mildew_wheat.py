...
# Fungus ##########################################################################
def set_lesions(g, nb_lesions=1., label='LeafElement'):
...
def test_initiate():
    ...
    fungus = powdery_mildew(); PowderyMildewDU.fungus = fungus
    stock = [PowderyMildewDU(nb_spores=rd.randint(1,100), status='emitted') for i in range(100)]
