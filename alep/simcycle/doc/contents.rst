...
- A `PDF <../latex/simcycle.pdf>`_ version of |simcycle| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:simcycle:simcycle>`__ wiki.
